...
def home():
    ...
    home_screen = SingleTable(home_screen_data, title="[git_cli]")
    print(home_screen.table)
...
def showUser():
    ...
    print(SingleTable(user_data).table)
    sys.exit(0)
...
if ch == "1":
    ...
    print("[git_cli] You know what you're typing...")
